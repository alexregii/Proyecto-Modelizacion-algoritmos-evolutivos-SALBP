...
def graficosYDatos(nombreArch, m):
    ...
    for i in range (10):
        ...
        print(f"Prueba: {i+1}")
        mejor1,(nombre1,tuplas1)=genetic(seleccion,pob_init,10000,100,n,m,anterioridad,task_times,1)
...
def main():
    # print(buscar_valor_optimo("scholl",33))

    graficosYDatos(r"precedenceGraphs\scholl.in2",33)
