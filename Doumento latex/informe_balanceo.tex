...
Cabe destacar que el caso del grafo de Scholl es especial, ya que es el más grande entre los grafos considerados, con 297 nodos. Los resultados obtenidos con los demás grafos, que se presentan a continuación, son considerablemente más satisfactorios.
El $\%$ de error indica el error relativo entre el tiempo de ciclo de la solución encontrada y el de la solución exacta:
\begin{table}[H]
    \centering
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        \hline
        \textbf{Grafo} & $\mathbf{m}$ & \textbf{n° individuos} & \textbf{n° generaciones} & \textbf{\% Error} & \textbf{\% del espacio explorado} \\
        \hline
        BUXEY      & 10 & 500 & 500  & $0$  & $1.3$ \\
        LUTZ1      & 8  & 500 & 1000 & $0$  & $2.4$ \\
        ...
        HAHN    & 4 & 500 & 100  & $0$  & $1.7$\\
        LUTZ3    & 6 & 500 & 200  & $0.36$ & $0.017$  \\
        BUXEY   & 14 & 500 & 200  & $0$ & $0.32$  \\
	    MUKHERJE  & 5 & 500 & 200  & $0$ & $0.18$  \\
	    SAWYER  & 7 & 500 & 100  & $2.1$ & $2.4$  \\
        \hline
    \end{tabular}
